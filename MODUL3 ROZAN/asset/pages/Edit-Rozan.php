    ...
    <?php 
        ...
        <section class="container mt-5">
			<div class="row">
                ...
                <p class="fst-italic text-secondary">Edit Detail Mobil <?php echo $data['nama_mobil'] ?></p>
				...
				<div class="col-6">
					<form action="../config/edit.php" method="POST" enctype="multipart/form-data">
						<div class="mb-3">
							...
							<input type="text" name="carname" class="form-control mb-3 mt-3" value="<?php echo $data['nama_mobil']; ?>"  >	
						</div>
                        <div class="mb-3">
							<span class="fw-bold">Nama Pemilik</span>
							<input type="text" name="owner" class="form-control mb-3 mt-3" value="<?php echo $data['pemilik_mobil']; ?>" >	
						</div>
                        <div class="mb-3">
							<span class="fw-bold">Merk</span>
							<input type="text" name="brand" class="form-control mb-3 mt-3" value="<?php echo $data['merk_mobil']; ?>" >	
						</div>
                        <div class="mb-3">
							<span class="fw-bold">Tanggal Beli</span>
							<input type="text" name="date" class="form-control mb-3 mt-3" value="<?php echo $data['tanggal_beli']; ?>" >	
						</div>
                        <div class="mb-3">
							<span class="fw-bold">Deskripsi</span>
							<textarea class="form-control" value="" name="date" id="" cols="30" rows="10" ><?php echo $data['deskripsi']; ?></textarea>	
						</div>
                        <div class="mb-3">
							<span class="fw-bold">Foto</span>
							<input type="file" name="photo" class="form-control mb-3 mt-3" value="<?php echo $data['foto_mobil'];?>" >	
						</div>
                        ...
                        <div class="mb-5 mt-3">
                            <button style="width: 150px;" type="submit" name="update" class="btn btn-primary rounded-5">Simpan</button>
                        </div>
                        <?php } ?>
				</div>
				</form>
